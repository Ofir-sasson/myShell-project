    ...
    if (!cmd2) {
        ...
        if (check1 != -1 && check2 != -1) {
            ...
            if (!danger1 && !danger2) {
                ...
                wait_status(status1, fp, cmd_count, last_time, avg_time, min_time, max_time, input, start1, end1);
                wait_status(status2, fp, cmd_count, last_time, avg_time, min_time, max_time, input, start2, end2);
            }
